...
export default function TaskDetail({
  ...
  taskId: string;
  task: ITask | { success: boolean; message: string };
}) {
                ...
                {openEmployeePicker && (
                  <EmployeePicker
                    ...
                    onSelect={(employees: IEmployee[]) => {
                      fetcher.submit(
                        {
                          op: 'updateAssigneeList',
                          value: JSON.stringify({
                            assigneeIds: employees.map(
