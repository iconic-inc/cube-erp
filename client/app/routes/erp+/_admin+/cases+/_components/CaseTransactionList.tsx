...
interface CaseTransactionListProps {
  caseId: string;
  caseTransactionsPromise: ILoaderDataPromise<IListResponse<ITransaction>>;
}

export default function CaseTransactionList({
  caseId,
  caseTransactionsPromise,
}: CaseTransactionListProps): JSX.Element {
  return (
    <Card className='rounded-xl overflow-hidden shadow-lg border border-gray-200'>
      ...
      <CardContent className='p-4 sm:p-6'>
        <Defer resolve={caseTransactionsPromise}>
          {(transactionsData) => {
