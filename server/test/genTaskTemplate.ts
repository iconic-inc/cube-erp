import { TASK } from '../src/api/constants';
import { ITaskTemplateCreate } from '../src/api/interfaces/taskTemplate.interface';
import { TaskTemplateModel } from '../src/api/models/taskTemplate.model';

export async function genTaskTemplate() {
