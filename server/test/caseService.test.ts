...
} from '../src/api/services/caseService.service';
import { CaseServiceModel } from '../src/api/models/caseService.model';
import { CustomerModel } from '../src/api/models/customer.model';
import { EmployeeModel } from '../src/api/models/employee.model';
import { UserModel } from '../src/api/models/user.model';
import { DocumentModel } from '../src/api/models/document.model';
import { DocumentCaseModel } from '../src/api/models/documentCase.model';
import {
  ICaseServiceCreate,
  ICaseServiceUpdate,
  ICaseServiceQuery,
  ...
  InstallmentPlanItem,
  IncurredCost,
} from '../src/api/interfaces/caseService.interface';
import { CASE_SERVICE, USER, CUSTOMER } from '../src/api/constants';
import { BadRequestError, NotFoundError } from '../src/api/core/errors';
import bcrypt from 'bcrypt';
import { randomBytes } from 'crypto';
import { RoleModel } from '../src/api/models/role.model';
import { genResource } from './genResource';
import { genRole } from './genRole';
import { DocumentFolderModel } from '../src/api/models/documentFolder.model';
import { genTaskTemplate } from './genTaskTemplate';

describe('CaseService', () => {
  let testCustomer: any;
  let testEmployee: any;
  let testUser: any;
  let testDocumentFolder: any;
  ...
  beforeEach(async () => {
    ...
    testCustomer = await CustomerModel.create({
      ...
      cus_address: { street: '123 Main St' },
    });
    ...
    testDocumentFolder = await DocumentFolderModel.create({
      fol_name: 'Test Folder',
      fol_owner: testEmployee._id,
    });
    ...
    testDocument = await DocumentModel.create({
      ...
      doc_isPublic: true,
      doc_parent: testDocumentFolder._id,
    });
  });
  ...
  describe('getCaseServiceById', () => {
    beforeEach(async () => {
      testCaseService = await createCaseService({
        ...
        participants: [
          {
            ...
            commission: { type: 'PERCENT_OF_GROSS', value: 10 },
          },
        ],
        pricing: {
          baseAmount: 1000,
